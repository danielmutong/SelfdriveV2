...
float selfdrive::self_drive_control(single_line left_bound[], single_line right_bound[], float lasterr){
  ...
  int offsetleft = (300 - left_bound[2].x0 );
  int offsetright = (right_bound[2].x0 - 300);  
  ...
  cout << "test point" << offset << " " << left_bound[2].x0 << " " << right_bound[2].x0  << endl;
  uhid_key_event(pfds.fd, USB_KEY_W, 40);
